...
%Constants:
inertia = 0.317961677/2; %rocket inertia in kg*m^2 (0.317961677kg*m^2 full scale)
...
rktdiam_2 = 2.25; %second stage diameter (4in)
...
for n = 1:numberofsteps
    ...
    avg_ohmega(n+1) = (ohmega(n+1) + ohmega_2(n+1))/2;
end
...
plot(time,ohmega_2) %provide a Y axis for the graph
plot(time,avg_ohmega)
