...
for n = 1:numberofsteps
    ...
    moment(n) = (cl*finarea*airdensity*speed^2)/2 * momentrad; %moment about the longitudinal axis of the rocket caused by the lift of the fins
    dampingmoment = 0; %moment caused by damping of the fins - this needs to be updated to include skin friction
    alpha = (moment(n)-dampingmoment)/inertia; %calculate angular acceleration in radians per second
